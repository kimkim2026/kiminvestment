...
> [TIP] **50% Rule:** 미국 부동산 투자자들이 가장 널리 쓰는 경험 법칙. "임대 수익의 절반은 운영비로 나간다"고 가정합니다. 재산세 $6,900 + 보험 $3,000 + 수리 $5,000 + 공실 $3,000 + CapEx $3,100 = $21,000. 모기지는 별도 계산합니다.
...
레버리지의 힘: 내 돈 $166,667로 $500,000 자산을 샀고, 그 자산이 2배가 됐습니다. 내 돈 기준으로는 **6배 이상의 자산 가치**가 생긴 것입니다. 여기에 원화 약세(+20.8%) 환차익까지 더해졌습니다.
...
S&P 500은 아무것도 안 하고도 10년 만에 2억이 9.6억이 됐지만, 22% 양도세를 내고 나면 7.3억이 됩니다. 하지만 **가장 쉽고 예측 가능한 투자**라는 점은 변하지 않습니다.
